...
// Apply takes the given apply declarative configuration, applies it and returns the applied iptablesSnatRule.
func (c *FakeIptablesSnatRules) Apply(ctx context.Context, iptablesSnatRule *kubeovnv1.IptablesSnatRuleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IptablesSnatRule, err error) {
	if iptablesSnatRule == nil {
		return nil, fmt.Errorf("iptablesSnatRule provided to Apply must not be nil")
	}
	data, err := json.Marshal(iptablesSnatRule)
	if err != nil {
		return nil, err
	}
	name := iptablesSnatRule.Name
	if name == nil {
		return nil, fmt.Errorf("iptablesSnatRule.Name must be provided to Apply")
	}
	emptyResult := &v1.IptablesSnatRule{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(iptablessnatrulesResource, *name, types.ApplyPatchType, data, opts.ToPatchOptions()), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.IptablesSnatRule), err
...
func (c *FakeIptablesSnatRules) ApplyStatus(ctx context.Context, iptablesSnatRule *kubeovnv1.IptablesSnatRuleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IptablesSnatRule, err error) {
	if iptablesSnatRule == nil {
		return nil, fmt.Errorf("iptablesSnatRule provided to Apply must not be nil")
	}
	data, err := json.Marshal(iptablesSnatRule)
	...
	emptyResult := &v1.IptablesSnatRule{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(iptablessnatrulesResource, *name, types.ApplyPatchType, data, opts.ToPatchOptions(), "status"), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.IptablesSnatRule), err
