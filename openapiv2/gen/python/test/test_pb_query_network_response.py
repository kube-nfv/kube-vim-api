        ...
        if include_optional:
            return PbQueryNetworkResponse(
                query_network_result = [
                    vivnfm_client.models.the_information_elements_in_this_group_encapsulates_information_of_an_instantiated_virtualised_network_resource/
...
In the NFVI, a virtual network transports information among the network interfaces of VM instances and physical network interfaces, providing the necessary connectiv(
                ...
                query_subnet_result = [
                    vivnfm_client.models.network_subnet.NetworkSubnet(
                ...
                query_trunk_result = [
                    vivnfm_client.models.virtual_trunk.VirtualTrunk()
                    ]
            )
        else:
            return PbQueryNetworkResponse(
