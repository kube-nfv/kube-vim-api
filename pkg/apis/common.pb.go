...
const (
	NetworkType_NETWORK_TYPE_OVERLAY  NetworkType = 0
	NetworkType_NETWORK_TYPE_UNDERLAY NetworkType = 1
	// SR-IOV VF pool realized via sriov-cni + Multus NetworkAttachmentDefinition.
	// providerNetwork = device plugin resource name (k8s.v1.cni.cncf.io/resourceName)
	// segmentationId  = VLAN ID (0 = untagged)
	// bandwidth       = min_tx_rate in Mbps (0 = no guarantee)
	NetworkType_NETWORK_TYPE_SRIOV NetworkType = 2
)

// Enum value maps for NetworkType.
var (
	NetworkType_name = map[int32]string{
		0: "NETWORK_TYPE_OVERLAY",
		1: "NETWORK_TYPE_UNDERLAY",
		2: "NETWORK_TYPE_SRIOV",
	}
	NetworkType_value = map[string]int32{
		"NETWORK_TYPE_OVERLAY":  0,
		"NETWORK_TYPE_UNDERLAY": 1,
		"NETWORK_TYPE_SRIOV":    2,
	}
)
...
const (
	...
	TypeVirtualNic_TYPE_VIRTUAL_NIC_BRIDGE TypeVirtualNic = 0
	// PCI Path-through allows a compute instance to have a direct and exclusive access to the physical PCI devices.
	TypeVirtualNic_TYPE_VIRTUAL_NIC_PATHTHROUGH TypeVirtualNic = 2
	// Extension of PCIe that allows a single PCI device (NIC) to be shared among multiple VMs.
	TypeVirtualNic_TYPE_VIRTUAL_NIC_SRIOV TypeVirtualNic = 3
)

// Enum value maps for TypeVirtualNic.
var (
	TypeVirtualNic_name = map[int32]string{
		0: "TYPE_VIRTUAL_NIC_BRIDGE",
		2: "TYPE_VIRTUAL_NIC_PATHTHROUGH",
		3: "TYPE_VIRTUAL_NIC_SRIOV",
	}
	TypeVirtualNic_value = map[string]int32{
		"TYPE_VIRTUAL_NIC_BRIDGE":      0,
		"TYPE_VIRTUAL_NIC_PATHTHROUGH": 2,
		"TYPE_VIRTUAL_NIC_SRIOV":       3,
	}
)
...
var file_common_common_proto_rawDesc = []byte{
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x1f, 0x0a, 0x09, 0x49, 0x50,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x50, 0x56, 0x34, 0x10,
	0x00, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x50, 0x56, 0x36, 0x10, 0x01, 0x2a, 0x2d, 0x0a, 0x10, 0x4f,
	...
	0x44, 0x49, 0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x2a, 0x4b, 0x0a, 0x13, 0x4e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0b, 0x0a, 0x07, 0x4e, 0x45, 0x54, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x00, 0x12, 0x0a,
	0x0a, 0x06, 0x53, 0x55, 0x42, 0x4e, 0x45, 0x54, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x4e, 0x45,
	0x54, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x50, 0x4f, 0x52, 0x54, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05,
	0x54, 0x52, 0x55, 0x4e, 0x4b, 0x10, 0x03, 0x2a, 0x82, 0x01, 0x0a, 0x13, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x0d, 0x0a, 0x09, 0x53, 0x55, 0x53, 0x50, 0x45, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x05, 0x12, 0x0f,
	0x0a, 0x0b, 0x54, 0x45, 0x52, 0x4d, 0x49, 0x4e, 0x41, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x06, 0x12,
	0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x07, 0x2a, 0x5a, 0x0a, 0x0b,
	0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12, 0x18, 0x0a, 0x14, 0x4e,
	0x45, 0x54, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4f, 0x56, 0x45, 0x52,
	0x4c, 0x41, 0x59, 0x10, 0x00, 0x12, 0x19, 0x0a, 0x15, 0x4e, 0x45, 0x54, 0x57, 0x4f, 0x52, 0x4b,
	...
	,
